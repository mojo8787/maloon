...
const translations = {
  en: {
    ...
    'services.iraq.energy.desc': 'Our systems are optimized for Iraq\'s extreme temperature variations, helping reduce energy consumption by up to 30% with intelligent HVAC control strategies.',
    'services.iraq.support.desc': 'With offices in Baghdad and Erbil, our local technical teams provide rapid response and support for all BMS deployments throughout Iraq.',
    ...
    'careers': 'Careers',
    'blog': 'Blog',
    'address.line1': '123 Smart Building Avenue',
    'address.line2': 'Tech District, City',
    'address.line3': 'Country',
    'email': 'info@spacegate.com',
    'phone': '+123 456 7890',
  },
  ar: {
    'site.title': 'سبيس جيت',
    ...
    'services.iraq.energy.desc': 'تم تحسين أنظمتنا لتناسب تقلبات درجات الحرارة الشديدة في العراق، مما يساعد على تقليل استهلاك الطاقة بنسبة تصل إلى 30٪ باستخدام استراتيجيات ذكية للتحكم في أنظمة التدفئة والتهوية وتكييف الهواء.',
    'services.iraq.support.desc': 'مع وجود مكاتب في بغداد وأربيل، توفر فرقنا الفنية المحلية استجابة وخدمة سريعة لجميع أنظمة إدارة المباني في جميع أنحاء العراق.',
    ...
    'careers': 'الوظائف',
    'blog': 'المدونة',
    'address.line1': '١٢٣ شارع المباني الذكية',
    'address.line2': 'حي التقنية، المدينة',
    'address.line3': 'الدولة',
    'email': 'info@spacegate.com',
    'phone': '+123 456 7890',
  }
};
